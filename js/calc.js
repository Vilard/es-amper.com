$(document).ready(function() {
	...
	$('.calc select').change(function(){
		...
		var $electrical_box = $premiss * 2;
		var	$cutout = $electrical_box + 2;													//колличество автоматов
		var $electrical_board = $cutout;													//Величина щита
		...
		if ( $electrical_board <= 12){
			$electrical_board_price = 1500;
			}	else if ( 12 < $electrical_board <= 24){
				$electrical_board_price = 3000;
				} else if ( 24 < $electrical_board <= 36 ){
					$electrical_board_price = 4500;
		};
		var	$commutation_electrical_board_price = $electrical_board * 110;													//колличество автоматов
		...
		//console.log($electrical_board_price);
